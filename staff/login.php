...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($auth->loginStaff($username, $password)) {
            header('Location: dashboard.php');
            exit();
        } else {
        ...
        <div class="container">
            <div class="form-container">
                <div class="card-header">
                    <h2 class="card-title">Medical Staff Login</h2>
                    <p>Access medical administration and patient care tools</p>
                </div>
            ...
            <div class="card" style="max-width: 500px; margin: 2rem auto; background: #f0f8ff;">
                ...
                <div style="background: white; padding: 1rem; border-radius: 5px; margin: 1rem 0;">
                    <strong>Staff Demo Account:</strong><br>
                    Username: <code>staff_demo</code><br>
