...
if ($auth->isLoggedIn() && $auth->isExternal()) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($auth->loginExternal($username, $password)) {
            header('Location: dashboard.php');
            exit();
        } else {
        ...
        <div class="container">
            <div class="form-container">
                <div class="card-header">
                    <h2 class="card-title">External Health Office Login</h2>
                    <p>Upload and transfer patient information between healthcare facilities</p>
                </div>
            ...
            <div class="card" style="max-width: 500px; margin: 2rem auto; background: #f0f8ff;">
                ...
                <div style="background: white; padding: 1rem; border-radius: 5px; margin: 1rem 0;">
                    <strong>External Health Office Demo Account:</strong><br>
                    Username: <code>external_demo</code><br>
