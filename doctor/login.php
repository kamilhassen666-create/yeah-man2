...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if (login_user($username, $password, 'doctor')) {
            header('Location: dashboard.php');
            exit();
        } else {
...
<body>
    <div class="login-container doctor-login">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    <label for="username">
                        <i class="fas fa-user-md"></i> Username
                    </label>
            ...
            <div class="login-links">
                <p>Access restricted to authorized medical professionals.</p>
    ...
    <style>
        ...
        .doctor-login .btn-primary {
            background: #059669;
        }

        .doctor-login .btn-primary:hover {
            background: #047857;
        }
